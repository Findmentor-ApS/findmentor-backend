...
{
    $appname = DI::env('APP');
    $url = "https://" . DI::env('API') . "/auth/validate_email/$type/$token";
...
{
    $appname = DI::env('APP');
    $url = "https://" . DI::env('API') . "/auth/validate_login/$type/$token";
...
{
    $appname = DI::env('APP');
    $url = "http://" . DI::env('API') . "/auth/validate_email/$type/$token";
    $subject = "Validate Email " . $appname;
    $message = <<<EOF
    <big><big>
    Hi,<br/><br/>
